...
4. Enable **Inject attack prompt** and run again. Explain that the malicious instruction is only
...
5. In the terminal, run `.venv/bin/python -m eval.run`. Show the 25-scenario scorecard with zero
